    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.purchase_seva =   document.getElementById("purchase_seva").value;
    ...
    $(document).on(
        ...
        '#purchase_list_filter_location_id, \
                    #purchase_list_filter_supplier_id, #purchase_list_filter_payment_status,\
                     #purchase_list_filter_status,#purchase_seva',
        function() {
...
function get_purchase_entry_row(product_id, variation_id,product_qty=1) {
...
$('#add-product').click(function(){
    ...
    get_purchase_entry_row(product_id, variation_id,product_qty);
})

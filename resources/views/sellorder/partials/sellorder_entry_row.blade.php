@foreach( $variations as $variation)
    <tr>
        ...
        <td>
            ...
            <input class="form-control input-sm sellorder_quantity input_number mousetrap" value="{{@number_format($product_qty, $quantity_precision, $currency_details->decimal_separator,$currency_details->thousand_separator)}}" name="sellorder[{{$row_count}}][quantity]" 
                data-quota_qty="{{$quotas}}" data-sell_qty="{{$sell}}"
                ...
                data-msg-ss_product_check="@lang('validation.custom-messages.quotas_sell', ['quotas'=> $quotas, 'sell' => $sell  ])"

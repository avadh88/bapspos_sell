...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      @if(count($selected_contacts_array) >0)
      
        <a href="{{ action('HomeController@depatmentHome')}}" title="{{ __('lang_v1.go_back') }}" data-toggle="tooltip" data-placement="bottom" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right">
          <strong><i class="fa fa-window-close fa-lg"></i></strong>
        </a>
      
      @else
      
        <a href="{{ action('HomeController@index')}}" title="{{ __('lang_v1.go_back') }}" data-toggle="tooltip" data-placement="bottom" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right">
          <strong><i class="fa fa-window-close fa-lg"></i></strong>
        </a>

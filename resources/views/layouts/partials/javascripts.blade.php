...
<!-- <script src="{{ asset('AdminLTE/plugins/DataTables/pdfmake-0.1.32/pdfmake.js?v=' . $asset_v) }}"></script> -->
...
<script>
    ...
    var psm100 = {
    	start: moment('{{ Session::get("psm_100.start") }}'),
    	end: moment('{{ Session::get("psm_100.end") }}'),
    }
    console.log(psm100);
    @if(file_exists(public_path('AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js')))

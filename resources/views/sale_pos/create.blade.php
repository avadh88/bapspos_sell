	...
	<div class="row">
		<div class="@if(!empty($pos_settings['hide_product_suggestion']) && !empty($pos_settings['hide_recent_trans'])) col-md-10 col-md-offset-1 @else col-md-7 @endif col-sm-12">
			@component('components.widget', ['class' => 'box-success'])
				...
				{!! Form::hidden('restrict_sell_with_sellorder', $genral_store_settings['restrict_sell_with_sellorder'], ['id' => 'restrict_sell_with_sellorder']) !!}

				{!! Form::hidden('random_no',$myRange[0], ['id' => 'random_no']) !!}
					...
					<div class="row">
						<div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
							<div class="form-group" style="width: 100% !important">
								<div class="input-group">
									...
									<input type="hidden" id="default_customer_name" value="{{$defaultCustomerName}}" >
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select name="permanent_sell" class='form-control select2'>
									<option value="0">Permanent Sell No</option>
									<option value="1">Permanent Sell Yes</option>
								</select>
							</div>
						</div>
						@endif
						...
						<!-- <div id="seva_return hide">
							<div class="col-sm-6">
								...
								{!! Form::select('return_seva_by_customer_id', 
									$suppliers, null, ['class' => 'form-control select2', 'id' => 'return_seva_by_customer_id', 'placeholder' => 'Enter Supplier name','style' => 'width: 100%;']); !!}
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									{!! Form::label('mobile',"Mobile Number") !!}
										{!! Form::text('mobile','', ['class' => 'form-control input_number', 'placeholder' => 'Enter Mobile Number',	'id' => 'mobile']); !!}
									</div>
								</div>
							</div>
						</div> -->
						...
						<div class="hide @if(!empty($commission_agent))  col-sm-4 @else col-sm-6 @endif">
							<div class="form-group">
								<div class="input-group">
									...
									<input type="hidden" name="qty_available" id="qty_available" value="0">
									<input type="hidden" name="enable_stock" id="enable_stock" value="">
									<span class="input-group-btn">
						...
						<div class="hide @if(!empty($commission_agent)) col-sm-4 @else col-sm-4 @endif">
							<div class="form-group">
								<div class="input-group">
									...
									'autofocus' => is_null($default_location)? false : true, 'id' => 'product_qty']); !!}
									<span class="input-group-btn input-space" style="padding-left:15px;">
						...
						@if(!$departmentUser)
							...
							<div class="col-sm-6">
								<div class="form-group">
								{!! Form::label('damage_by_customer_id',"Damage by customer") !!}
								{!! Form::select('damage_by_customer_id', 
									$customers, null, ['class' => 'form-control select2', 'id' => 'damage_by_customer_id', 'placeholder' => 'Enter Customer name / phone', 'disabled' =>true,'style' => 'width: 100%;']); !!}
								</div>
							</div>
						@endif
						<div class="clearfix"></div>

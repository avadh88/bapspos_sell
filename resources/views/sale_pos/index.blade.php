...
$(document).ready( function(){
    ...
    else
    {
        ...
        sell_table_without_price = $('#sell_table_without_price').DataTable({
            ...
            //     $('#footer_sale_total').text(sum_table_col($('#sell_table_without_price'), 'final-total'));

            //     $('#footer_total_paid').text(sum_table_col($('#sell_table_without_price'), 'total-paid'));

            //     $('#footer_total_remaining').text(sum_table_col($('#sell_table_without_price'), 'payment_due'));
            //     $('#footer_total_sell_return_due').text(sum_table_col($('#sell_table_without_price'), 'sell_return_due'));

            //     $('#footer_payment_status_count ').html(__sum_status_html($('#sell_table_without_price'), 'payment-status-label'));
            //    __currency_convert_recursively($('#sell_table_without_price'));
            // },
            createdRow: function( row, data, dataIndex ) {
                //$( row ).find('td:eq(4)').attr('class', 'clickable_td');
            }

				...
				@forelse($receipt_details->lines as $line)
					<tr>
						<td style="word-break: break-all;">
							...
							@endif
                            <p style="width: 100%;">{{$line['name']}} <br>@if(!empty($line['rack_details'])) {{$line['rack_details']}} @endif </p>
...
<div class="row font10">
    <div class="col-xs-12">
    <hr/>
		Receive By: {{$receipt_details->additional_notes}}
		<br>
		Sell By: {{$receipt_details->service_staff}} 
    </div>
</div>
@endif

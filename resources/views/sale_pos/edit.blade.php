				...
				<div class="box-body">
					...
					<div class="row">
						<div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
							<div class="form-group">
								<div class="input-group">
									...
									value="{{ $transaction->contact->name }} ({{ $transaction->contact->mobile }})" >
						...
						<div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-4 @endif">
							<div class="form-group">
								<div class="input-group">
									{!! Form::text('product_qty','', ['class' => 'form-control input_number', 'placeholder' => __('sale.qty'), 'id' => 'product_qty']); !!}
								</div>
							</div>
						</div>
						...
						<!-- <div class="col-sm-4">
							<div class="form-group">
								Permanent Sell
								<select name="permanent_sell" class='form-control select2'>
									<option {{ $transaction->permanent_sell =='' ? '' : '' }} value="">Please Select</option>
									<option {{ $transaction->permanent_sell =='0'? 'selected=selected' : '' }} value="0">No</option>
									<option {{ $transaction->permanent_sell =='1'? 'selected=selected' : '' }} value="1">Yes</option>
								</select>
							</div>
						</div> -->
				     </div>
						...
						<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
							<thead>
								<tr>
									...
									<th class="text-center col-md-3 hide">
										@lang('sale.subtotal')
									</th>

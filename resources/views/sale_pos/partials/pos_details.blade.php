				...
				<table class="table table-condensed" 
					...
					<tr>
						<td>
							...
							<div class="col-sm-3 col-xs-12 d-inline-table hide">
					...
					<tr>
						<td>
							...
							<div class="col-sm-3 col-xs-6 col-2px-padding">
								<button type="button" 
								class="btn bg-maroon btn-block btn-flat no-print @if($pos_settings['disable_card'] != 0) hide @endif @if(!empty($pos_settings['disable_suspend'])) pos-express-btn btn-lg @endif pos-express-finalize" 
							...
							@if($departmentUser == 0)
								...
								<div class="col-sm-6 col-xs-12 col-2px-padding">
									<button type="button" class="btn bg-green  btn-block btn-flat btn-lg no-print @if($pos_settings['disable_pay_checkout'] != 0) hide @endif pos-express-btn" id="pos-send" title="@lang('lang_v1.tooltip_checkout_multi_pay')">
									<div class="text-center">
										<i class="fa fa-check" aria-hidden="true"></i>
										<b>@lang('Send')</b>
									</div>
					...
					<tr>
						<td>
							<div class="col-sm-5 col-xs-6 col-2px-padding"></div>
							<div class="col-sm-2 col-xs-6 col-2px-padding">
								<button type="button" 
										class="btn btn-info btn-block btn-flat @if($pos_settings['disable_quotation'] != 0) hide @endif" 
										id="pos-quotation">@lang('lang_v1.demand')</button>
							</div>
						</td>
					</tr>
					@endif

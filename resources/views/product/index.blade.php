...
<div class="row">
    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3 hide" id="disposable_filter">
            <div class="form-group">
                {!! Form::label('disposable_filter',  __('Disposable Filter') . ':') !!}
                {!! Form::select('disposable_filter',[''=>'All',1=>'Yes',0=>'No'], null, ['class' => 'form-control select2','id'=>'disposable_filter_data', 'style' => 'width:100%']); !!}
            </div>
        </div>
    @endcomponent
    </div>
    ...
    <script type="text/javascript">
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        { data: 'disposable_item', name: 'disposable_item'},
            ...
            $(document).on('change', '#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id,#disposable_filter_data', 
                function() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            if ($(e.target).attr('href') == '#product_stock_report') {
                ...
                $('#disposable_filter').removeClass('hide');
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                d.unit_id = $('#product_list_filter_unit_id').val();
                                d.type = $('#product_list_filter_type').val();
                                d.disposable_filter = $('#disposable_filter_data').val();
                            }
                        },
                        columns: [

        ...
        <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <br>
                <label>
                  {!! Form::checkbox('disposable_item', 1, $product->disposable_item, ['class' => 'input-icheck', 'id' => 'disposable_item']); !!} <strong>@lang('product.disposable_item')</strong>
                </label>
              </div>
              ...
              <div class="form-group">
                <br>
                <label>
                  {!! Form::checkbox('is_inactive', 1, $product->is_inactive, ['class' => 'input-icheck', 'id' => 'is_inactive']); !!} <strong>@lang('product.is_inactive')</strong>
                </label>
              </div>
            </div>

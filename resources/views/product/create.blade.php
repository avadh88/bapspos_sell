    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4">
          ...
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('disposable_item', 1, !empty($duplicate_product) ? $duplicate_product->disposable_item : false, ['class' => 'input-icheck', 'id' => 'disposable_item']); !!} <strong>@lang('product.disposable_item')</strong>
            </label>
          </div>
          ...
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('is_inactive', 1,!empty($duplicate_product) ? $duplicate_product->is_inactive : false, ['class' => 'input-icheck', 'id' => 'is_inactive']); !!} <strong>@lang('product.is_inactive')</strong>
            </label>
          </div>
        </div>
        </div>

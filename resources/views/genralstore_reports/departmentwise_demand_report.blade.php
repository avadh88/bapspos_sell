@extends('layouts.app')
@section('title', __('report.departmentwisedemandreport'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('report.departmentwisedemandreport')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('GenralstoreReportController@getDepartmentWiseDemandReport'), 'method' => 'get', 'id' => 'departwise_demand_report_filter_form' ]) !!}
                <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary'])
                @include('genralstore_reports.partials.departmentwise_demand_table')
            @endcomponent
        </div>
    </div>
</section>

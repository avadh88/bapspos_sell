@extends('layouts.app')
@section('title', __('report.totalpendingreport'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('report.totalpendingreport')}}</h1>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['url' => action('GenralstoreReportController@getTotalPendingReport'), 'method' => 'get', 'id' => 'total_pending_report_filter_form' ]) !!}
            <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @include('genralstore_reports.partials.total_pending_table')
            @endcomponent
        </div>
    </div>
</section>

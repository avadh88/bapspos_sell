@extends('layouts.app')
@section('title', __('report.overallsummaryreportdemand'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>{{ __('report.overallsummaryreportdemand')}}</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('GenralstoreReportController@getOverallProductSummaryReportDemand'), 'method' => 'POST', 'id' => 'overall_product_demand_summary_report_filter_form' ]) !!}
                <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary'])
                @include('genralstore_reports.partials.overall_product_demand_summary_table')
            @endcomponent
        </div>
    </div>
</section>

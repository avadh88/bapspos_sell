      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('hide_product_price', 1, !empty($invoice_layout->hide_product_price), ['class' => 'input-icheck']); !!} @lang('lang_v1.hide_product_price')</label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('hide_row_sub_total', 1, !empty($invoice_layout->hide_row_sub_total), ['class' => 'input-icheck']); !!} @lang('lang_v1.hide_row_sub_total')</label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('hide_payment_information', 1, !empty($invoice_layout->hide_payment_information), ['class' => 'input-icheck']); !!} @lang('lang_v1.hide_payment_information')</label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('show_rack_details', 1, $invoice_layout->show_rack_details, ['class' => 'input-icheck']); !!} @lang('lang_v1.show_rack_details')</label>
              </div>
          </div>
        </div>

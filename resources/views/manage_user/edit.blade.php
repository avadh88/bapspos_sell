        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="col-md-4">
              <div class="form-group">
                <div class="checkbox">
                  <label>
                      {!! Form::checkbox('login_with_otp', 1, $login_with_otp, ['class' => 'input-icheck status']); !!} {{ __('lang_v1.login_with_otp') }}
                  </label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <div class="checkbox">
                  <label>
                      {!! Form::checkbox('show_price', 1, $show_price, ['class' => 'input-icheck status']); !!} {{ __('lang_v1.show_price') }}
                  </label>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <br/>
                      <label>
                        {!! Form::checkbox('selected_category', 1, 
                        $user->selected_category, 
                        [ 'class' => 'input-icheck', 'id' => 'selected_category']); !!} {{ __( 'lang_v1.allow_selected_category' ) }}
                      </label>
                      @show_tooltip(__('lang_v1.allow_selected_category_tooltip'))
                    </div>
                </div>
            </div>

            <div class="col-sm-4 selected_category_div @if(!$user->selected_category) hide @endif">
                <div class="form-group">
                  {!! Form::label('selected_category', __('lang_v1.selected_category') . ':') !!}
                    <div class="form-group">
                      {!! Form::select('selected_category_ids[]', $category, $category_access, ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;' ]); !!}
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#selected_category').on('ifChecked', function(event){
      $('div.selected_category_div').removeClass('hide');
    });
    $('#selected_category').on('ifUnchecked', function(event){
      $('div.selected_category_div').addClass('hide');
    });
  });

  ...
  @component('components.widget')
      ...
      <div class="col-md-4">
        <div class="form-group">
          <div class="checkbox">
            <label>
                 {!! Form::checkbox('login_with_otp', 'active', false, ['class' => 'input-icheck status']); !!} {{ __('lang_v1.login_with_otp') }}
            </label>
            @show_tooltip(__('lang_v1.tooltip_enable_user_active'))
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          <div class="checkbox">
            <label>
                {!! Form::checkbox('show_price', 1, '', ['class' => 'input-icheck status']); !!} {{ __('lang_v1.show_price') }}
            </label>
      ...
      <div class="col-sm-4 selected_category_div hide">
          <div class="form-group">
            {!! Form::label('selected_category', __('lang_v1.selected_category') . ':') !!}
              <div class="form-group">
                {!! Form::select('selected_category_ids[]', $category,[], ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;' ]); !!}
              </div>
          </div>
      </div>
  @endcomponent

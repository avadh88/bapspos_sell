  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    {!! Form::label('purchase_seva', __('purchase.purchase_seva') . ':') !!}
                    {!! Form::select('purchase_seva', $purchaseSeva, $purchase->purchase_seva, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}

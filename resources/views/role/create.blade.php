  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sell.view_own_sell', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sell.online_demand', false, ['class' => 'input-icheck']); !!}
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellorder.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellorder.create', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellorder.update', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellorder.delete', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellreturn.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellreturn.create', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellreturn.update', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellreturn.delete', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sellreturn.view_own_sell', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'display_order.view', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisedemandreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.totaldemandreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisependingreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.totalpendingreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisesummaryreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.overallsummaryreport', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'genralstore_report.overallproductsummaryreport', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'gate_pass.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'gate_pass.create', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'gate_pass.update', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'gate_pass.delete', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'gate_pass.verify', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'custom_req.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'custom_req.create', false,
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'notification_template.notification_template', false,

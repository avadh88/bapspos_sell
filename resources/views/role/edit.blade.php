...
<section class="content">
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sell.view_own_sell', in_array('sell.view_own_sell', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sell.view_own_sell' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sell.online_demand', in_array('sell.online_demand', $role_permissions), ['class' => 'input-icheck']); !!}
                  {{ __('Sell Online Demand') }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellorder.view', in_array('sellorder.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellorder.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellorder.create', in_array('sellorder.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellorder.create' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellorder.update', in_array('sellorder.update', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellorder.update' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellorder.delete', in_array('sellorder.delete', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellorder.delete' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          <div class="col-md-1">
            <h4>@lang( 'sellreturn.sellreturn' )</h4>
          </div>
          <div class="col-md-2">
            <div class="checkbox">
                <label>
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellreturn.view', in_array('sellreturn.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellreturn.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellreturn.create', in_array('sellreturn.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellreturn.create' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellreturn.update', in_array('sellreturn.update', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellreturn.update' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellreturn.delete', in_array('sellreturn.delete', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellreturn.delete' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'sellreturn.view_own_sell', in_array('sellreturn.view_own_sell', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.sellreturn.view_own_sell' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'display_order.view', in_array('display_order.view', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.display_order.view' ) }}
              </label>
            </div>
        </div>
        ...
        <div class="row check_group">
          <div class="col-md-1">
            <h4>@lang( 'role.genralstore_reports' )</h4>
          </div>
          <div class="col-md-2">
            <div class="checkbox">
                <label>
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisedemandreport', in_array('genralstore_report.departmentwisedemandreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.departmentwisedemandreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.totaldemandreport', in_array('genralstore_report.totaldemandreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.totaldemandreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisependingreport', in_array('genralstore_report.departmentwisependingreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.departmentwisependingreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.totalpendingreport', in_array('genralstore_report.totalpendingreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.totalpendingreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.departmentwisesummaryreport', in_array('genralstore_report.departmentwisesummaryreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.departmentwisesummaryreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.overallsummaryreport', in_array('genralstore_report.overallsummaryreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.overallsummaryreport' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'genralstore_report.overallproductsummaryreport', in_array('genralstore_report.overallproductsummaryreport', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.overallproductsummaryreport' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'custom_req.view', in_array('custom_req.view', $role_permissions),
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.custom_req.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'custom_req.create', in_array('custom_req.create', $role_permissions),
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.custom_req.create' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          <div class="col-md-3">
            <h4>@lang( 'role.notification_template' )</h4>
          </div>
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                {!! Form::checkbox('permissions[]', 'notification_template.notification_template', in_array('notification_template.notification_template', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.notification_template' ) }}
                </label>
              </div>
            </div>
          </div>

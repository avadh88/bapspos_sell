<div class="pos-tab-content">
     <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $sellorder_prefix = !empty($business->ref_no_prefixes['sellorder']) ? $business->ref_no_prefixes['sellorder'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[sellorder]', __('lang_v1.sell_order') . ':') !!}
                {!! Form::text('ref_no_prefixes[sellorder]', $sellorder_prefix, ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $sell_return_genralstore_prefix = !empty($business->ref_no_prefixes['sell_return_genralstore']) ? $business->ref_no_prefixes['sell_return_genralstore'] : '';
                @endphp
                {!! Form::label('ref_no_prefixes[sell_return_genralstore]', __('lang_v1.sell_return_genralstore') . ':') !!}

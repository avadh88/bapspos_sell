    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_quotation]', 1,  
                        $pos_settings['disable_quotation'] , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_quotation' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_card]', 1,  
                        $pos_settings['disable_card'] , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.disable_card' ) }}
                  </label>
                </div>
            </div>
        </div>

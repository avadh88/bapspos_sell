        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.whatsapp_settings')</a>
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.modules')</a>
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.genralstore_setting')</a>
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.custom_requirement_notification')</a>
                </div>
            </div>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                <!-- tab 13 start -->
                @include('business.partials.genralstore_settings')
                <!-- tab 13 end -->

                <!-- tab 14 start -->
                @include('business.partials.custom_requirements_notifications')
                <!-- tab 14 end -->
            </div>
        </div>
        <!--  </pos-tab-container> -->

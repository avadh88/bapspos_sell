        ...
        @component('components.widget', ['class' => 'box-warning'])
          ...
          <div class="col-md-3">
              <div class="form-group">
                  ...
                  {!! Form::select('location_id', $all_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
              </div>
          </div>
          <div class="col-md-3">
              <div class="form-group">
                  {!! Form::label('category_id', __('category.category') . ':') !!}
                  {!! Form::select('category', $categories, null, ['placeholder' => __('messages.all'), 'class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'stock_category_id']); !!}
              </div>
          </div>
          <div class="col-md-1">
              <div class="form-group">
                <label for="category_id">Filter</label>
                <button type="button" id="submit-stcok-alert-filter" class="btn btn-primary pull-right btn-flat form-control">Filter</button>
              </div>
          </div>

...
<section class="content-header">
	<div class="row">
		<div class="col-sm-12">
			<a href="{!! url('/stock-transfers-all'); !!}"><button type="submit" id="add_multiple_items" class="btn btn-primary pull-right" >Add Multiple Items</button></a>
			<a href="{!! url('/stock-transfers-po'); !!}"><button type="submit" id="add_multiple_items_po" class="btn btn-primary pull-right" style="margin-right: 20px;">Add Items PO Wise</button></a>
		</div>
	</div>
</section>

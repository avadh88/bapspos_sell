...
class NotificationTemplate extends Model
{
    ...
    public static function getTemplate($business_id, $template_for)
    {
        ...
        $template = [
            ...
            'auto_send_sms' => !empty($notif_template->auto_send_sms) ? 1
                             : 0,
            'auto_send_whatsapp_message' => !empty($notif_template->auto_send_whatsapp_message) ? 1
                             : 0,
    ...
    public static function customerNotifications()
    {
        return [
            ...
            'sell_return_genralstore'=>['name'=>__('lang_v1.sell_return_genralstore')],
            ...
            'departmentwise_pending'=>['name'=>__('lang_v1.departmentwise_pending')],
        ];
    }

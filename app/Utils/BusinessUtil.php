...
class BusinessUtil extends Util
{
     ...
     * @return array
     */
    public function getPSM100Year($business_id)
    {
        $start_month = 1;
        $end_month = 5;
    ...
    {
        return ['disable_pay_checkout' => 0, 'disable_draft' => 0, 'disable_express_checkout' => 0, 'hide_product_suggestion' => 0, 'hide_recent_trans' => 0, 'disable_discount' => 0, 'disable_order_tax' => 0, 'is_pos_subtotal_editable' => 0,'disable_quotation'=>0,'disable_card'=>0];
    }
    ...
    {
        return ['url' => '','version'=>'','business_id'=>'','phone_number_id'=>'','user_access_token'=>'','waba-id'=>''];
    }

    /**
     * Return the default setting for the Genralstore screen.
     *
     * @return array
     */
    public function defaultGenralStoreSettings()
    {
        return ['restrict_sell_with_sellorder' => 0];
    }

    public function defaultCustomReqSettings()
    {
        return ['notify_mob_no' =>''];
    }
}

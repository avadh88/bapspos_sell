...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if (request()->purchase_seva!='') {
                $purchases->where('transactions.purchase_seva', request()->purchase_seva);
            }
        ...
        $purchaseSeva=[0=>'No',1=>'Yes'];
        return view('purchase.index')
            ->with(compact('business_locations', 'suppliers', 'orderStatuses','purchaseSeva'));
    }
    ...
    public function create()
    {
        ...
        return view('purchase.create')
            ->with(compact('taxes', 'orderStatuses', 'business_locations', 'currency_details', 'default_purchase_status', 'customer_groups', 'types', 'shortcuts', 'payment_line', 'payment_types', 'accounts','purchaseSeva'));
    }
    ...
    {   
        ...
        try {
            ...
            $transaction_data = $request->only([ 'ref_no', 'status', 'contact_id', 'transaction_date', 'total_before_tax', 'location_id','discount_type', 'discount_amount','tax_id', 'tax_amount', 'shipping_details', 'shipping_charges', 'final_total', 'additional_notes', 'exchange_rate','purchase_seva']);
        ...
        return redirect('purchases/create')->with('status', $output);
    }

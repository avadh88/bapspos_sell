...
class ContactController extends Controller
{
    ...
    private function indexSupplier()
    {
        ...
        $contact = Contact::leftjoin('transactions AS t', 'contacts.id', '=', 't.contact_id')
                    ...
                    ->onlySuppliers()
                    ->select(['contacts.contact_id', 'supplier_business_name', 'name', 'contacts.mobile',
    ...
    private function indexCustomer()
    {
        ...
        $contact = Contact::leftjoin('transactions AS t', 'contacts.id', '=', 't.contact_id')
                    ...
                    ->where('contacts.business_id', $business_id)
                    ->onlyCustomers()
                    ->addSelect(['contacts.contact_id', 'contacts.name', 'cg.name as customer_group', 'city', 'state', 'country', 'landmark', 'contacts.mobile', 'contacts.id', 'is_default',

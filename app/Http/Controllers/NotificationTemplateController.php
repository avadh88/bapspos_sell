...
class NotificationTemplateController extends Controller
{
    ...
    {
        if (!auth()->user()->can('notification_template.notification_template')) {
        ...
        foreach ($customer_notifications as $key => $value) {
            ...
            $customer_notifications[$key]['auto_send_whatsapp_message'] = $notification_template['auto_send_whatsapp_message'];
        }
        ...
        foreach ($template_data as $key => $value) {
            NotificationTemplate::updateOrCreate(
                ...
                [
                    ...
                    'auto_send_whatsapp_message' => !empty($value['auto_send_whatsapp_message']) ? 1 : 0
                ]
            );
        }

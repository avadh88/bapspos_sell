...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->user()->can('sell.view_own_sell') && auth()->user()->roles->first()->name != 'Admin#'.$business_id)
        {
        ...
        return view('sell.index')->with(compact('business_locations', 'customers', 'is_woocommerce','users','userId','departmentUser'));
    }
    ...
    public function getDraftDatables()
    {
        // if (request()->ajax()) {
            ...
            $sells->groupBy('transactions.id')->orderBy('transaction_date','desc');

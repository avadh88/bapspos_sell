...
class Transaction extends Model
{
    ...
    public function sellorder_lines()
    {
        return $this->hasMany(\App\SellOrderLines::class);
    }
    public function sellreturngenralstore_lines()
    {
        return $this->hasMany(\App\SellReturnLines::class);
    }

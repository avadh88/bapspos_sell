...
class CreateProcedureForDemand extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure = "
        CREATE PROCEDURE overall_summary_demand_product(IN _locationId TEXT,IN _transType TEXT,IN _startDate TEXT,IN _endDate TEXT)
            BEGIN
                ...
                FROM transactions trans JOIN contacts 
                    ...
                    JOIN sell_order_lines tsl on tsl.transaction_id = trans.id where trans.`location_id` =@locationid  
                ...
                SET @sql = CONCAT(
                            ...
                            ' FROM sell_order_lines tsl JOIN products pro
        ...
        DB::unprepared("DROP PROCEDURE IF EXISTS overall_summary_demand_product");
    ...
    {
        Schema::dropIfExists('procedure_for_demand');
    }
}
